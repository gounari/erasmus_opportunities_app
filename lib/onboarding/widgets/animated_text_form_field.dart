...
class AnimatedNameTextFormField extends StatefulWidget {
  AnimatedNameTextFormField({
    Key key,
    this.interval = const Interval(0.0, 1.0),
    @required this.animatedWidth,
    this.loadingController,
  ...
  @override
  _AnimatedNameTextFormFieldState createState() =>
      _AnimatedNameTextFormFieldState();
}

class _AnimatedNameTextFormFieldState
    extends State<AnimatedNameTextFormField> {
...
class AnimatedLocationTextFormField extends StatefulWidget {
  AnimatedLocationTextFormField({
    Key key,
    this.interval = const Interval(0.0, 1.0),
    @required this.animatedWidth,
    this.loadingController,
  ...
  @override
  _AnimatedLocationFormFieldState createState() =>
      _AnimatedLocationFormFieldState();
}

class _AnimatedLocationFormFieldState
    extends State<AnimatedLocationTextFormField> {
  ...
  Widget build(BuildContext context) {
    return AnimatedTextFormField(
      ...
      enabled: widget.enabled,
      labelText: widget.labelText,
      prefixIcon: Icon(FontAwesomeIcons.mapPin, size: 20),
      keyboardType: widget.keyboardType,
      textInputAction: widget.textInputAction,
      controller: widget.controller,
      focusNode: widget.focusNode,
